...
\hline
 ...
 \textbf{41}   & 1a30, 1i1, 1x, 1f8.3, & \tt input\_names(41), constraint\_switch( 3), 1x, constraint\_read( 3,1), \\
...
% \textbf{53}   & 1a30, 1i1, 1x, 1f8.3 & \tt input\_names(53), constraint\_switch(16), 1x, constraint\_read(16) \\
 ...
 \textbf{53}   & 1a30, 1i1, 1x, 1f8.3, & \tt input\_names(53), constraint\_switch(53), 1x, constraint\_read(16,1), \\
               &            1x, 1f8.3 & \tt                                           1x, constraint\_read(16,2) \\
...
\item \ttt{constraint\_switch(j)}: option to switch on/off the constraint \ttt{j}. \\[0.05cm]
  ...
  \ttt{= 1\:} the constraint \ttt{j} is switched on (global constraint for the nucleons).
  \ttt{= 2\:} the constraints \ttt{j} are switched on (separate constraints for protons and neutrons). This option is only valid 
  for the constraints on the multipole moments.
